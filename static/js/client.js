        ...
        if ((prevChartWidth != chartWidth) || (prevChartHeight != chartHeight)) {
            ...
            if (init) {
                ...
                focus.append('line')
                    .attr('class', 'low-line')
                    .attr('x1', xScale(dataRange[0]))
                    .attr('y1', yScale(scaleBg(75)))
                    .attr('x2', xScale(dataRange[1]))
                    .attr('y2', yScale(scaleBg(75)))
                    .style('stroke-dasharray', ('3, 3'))
                    .attr('stroke', 'grey');
                ...
                context.append('line')
                    .attr('class', 'low-line')
                    .attr('x1', xScale(dataRange[0]))
                    .attr('y1', yScale2(scaleBg(75)))
                    .attr('x2', xScale(dataRange[1]))
                    .attr('y2', yScale2(scaleBg(75)))
                    .style('stroke-dasharray', ('3, 3'))
                    .attr('stroke', 'grey');
        ...
        if (d.length > 1) {
            ...
            if (d[0].length) {
                ...
                if (browserSettings.alarmLow) {
                    $('.container .current').toggleClass('low', latestSGV.y < 75);
                }
            }
